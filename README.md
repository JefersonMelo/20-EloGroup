...
o Bubble Sort é de implementação simples e bastante eficiente em listas muito grandes.
um item da lista no Selection Sort é selecionado e sempre comparado ao item adjacente, havendo troca, se a condição de ordenação for satisfeita.
...
[Solução C#](https://github.com/JefersonMelo/20-Invilia/blob/master/AbastecimentoF1/Program.cs)
